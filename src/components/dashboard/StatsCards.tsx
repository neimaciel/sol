...
export function StatsCards() {
    return (
        <div className="grid gap-3 grid-cols-2 lg:grid-cols-4">
            {stats.map((stat) => (
                <div key={stat.title} className="glass-hover group">
                        ...
                        <div className="flex items-center gap-1.5">
                            {stat.trend === 'up' ? (
                                ...
                                <>
                                    ...
                                    <span className="text-xs font-bold text-red-600">{stat.change}</span>
                                </>
                            )}
                            <span className="text-xs text-gray-400">vs mês</span>
                        </div>
                    </div>
                </div>
            ))}
